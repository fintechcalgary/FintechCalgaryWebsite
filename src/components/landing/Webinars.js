...
export default function Webinars({ events }) {
      ...
      <div className="container mx-auto px-4">
        ...
        {events.length > 0 ? (
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl p-12 rounded-2xl border border-gray-700/50 max-w-3xl mx-auto text-center">
            ...
            <p className="text-3xl text-gray-300 mb-4">No webinars available</p>
            <p className="text-xl text-gray-400">
              Once webinars have ended, you&apos;ll find their recordings here.
            </p>
          </div>
        )}
      </div>
