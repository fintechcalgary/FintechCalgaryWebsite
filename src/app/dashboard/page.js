              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Link
                    ...
                    className="group relative overflow-hidden bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-lg font-semibold text-white">
                    ...
                    <p className="text-gray-300 text-sm">
                      Review executive team applications
                    </p>
                    <div className="absolute bottom-2 right-2 text-orange-400 group-hover:translate-x-1 transition-transform duration-300">
                      <svg
                        className="w-4 h-4"
                        fill="none"
                        stroke="currentColor"
