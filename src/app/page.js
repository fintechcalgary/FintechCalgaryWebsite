        ...
        <section className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden pt-24 pb-20 md:pt-28 md:pb-24">
          ...
          <div className="pointer-events-none absolute inset-0 z-[1] overflow-visible">
            <Image
              ...
              height={900}
              priority
              className="absolute left-1/2 top-[42%] min-h-[115vmin] min-w-[115vmin] -translate-x-1/2 -translate-y-1/2 opacity-[0.72] saturate-[1.15] contrast-[1.08] drop-shadow-[0_0_60px_rgba(202,60,255,0.35)] sm:opacity-[0.82] md:top-[44%] md:min-h-[132vmin] md:min-w-[132vmin] md:opacity-[0.92] lg:top-[51%] lg:min-h-[135vmin] lg:min-w-[135vmin] xl:top-[57%] xl:min-h-[138vmin] xl:min-w-[138vmin] 2xl:top-[60%] 2xl:min-h-[141vmin] 2xl:min-w-[141vmin]"
            />
          </div>

          <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
            <h1 className="animate-fade-in-down bg-gradient-to-br from-white via-white to-white/75 bg-clip-text pb-2 text-[clamp(3.125rem,calc(2.25rem+5vw),3.75rem)] font-extrabold leading-[0.98] tracking-[-0.03em] text-transparent drop-shadow-[0_3px_28px_rgba(0,0,0,0.55)] max-[380px]:text-[clamp(3rem,calc(1.85rem+7.5vw),3.5rem)] sm:pb-3 sm:text-6xl sm:tracking-tight sm:leading-[1.05] md:text-7xl xl:text-8xl xl:leading-[1.02]">
              FinTech{" "}
              <span className="bg-gradient-to-r from-primary via-fuchsia-400 to-pink-400 bg-clip-text text-transparent drop-shadow-[0_2px_20px_rgba(0,0,0,0.35)]">
                Calgary
              </span>
            </h1>

            <p className="animation-delay-300 animate-fade-in-down mx-auto mt-4 max-w-2xl text-base font-light leading-relaxed text-gray-400 max-[380px]:mt-3 sm:mt-5 sm:text-lg md:text-xl md:leading-relaxed">
            ...
            <div className="animation-delay-600 animate-fade-in-up mx-auto mt-10 flex max-w-[320px] flex-col items-stretch gap-3 sm:mx-0 sm:mt-12 sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4">
              <Link
                href="/join"
                className="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-primary to-fuchsia-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-primary/25 ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-primary/35 sm:w-auto sm:py-4 sm:text-lg"
              >
                Join Us
              </Link>
              <Link
                href="/partner-signup"
                className="group inline-flex w-full items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] px-8 py-3.5 text-base font-semibold text-white backdrop-blur-md transition-all duration-300 hover:border-primary/35 hover:bg-white/[0.07] sm:w-auto sm:py-4 sm:text-lg"
              >
                Become an Associate
